...
int main()
{
    ...
    cin >> numApprove;
    cout << "How many of them disapprove of the way the president is handling his job? " //"forgot" a ';'
    ...
    cout < pctDisapprove << "% say they disapprove." << endl; //forgot the second < sign, no compiling
